...
describe('empty spec', () => {
    it('passes', () => {
      ...
      cy.visit('http://127.0.0.1:8080/updatecontact/1')
  ...
  it('.type() - type into a DOM element', () => {
    ...
    cy.get('.update-email')
      ...
      cy.get('.update-number')
      .type('959595').should('have.value', '0959595')
  ...
  context('Location', () => {
    ...
    it('cy.location() - get window.location', () => {
      ...
      cy.location().should((location) => {
        ...
        expect(location.href).to.eq('http://127.0.0.1:8080/updatecontact/1')
        ...
        expect(location.pathname).to.eq('/updatecontact/1')
    ...
    it('cy.url() - get the current URL', () => {
      ...
      cy.url().should('eq', 'http://127.0.0.1:8080/updatecontact/1')
    })
  })
